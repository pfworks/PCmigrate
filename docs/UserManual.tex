...
For the retro DOS-style interface, run \texttt{PCmigrate-Retro.ps1} instead.
...
\begin{description}[style=nextline]
    ...
    \item[\texttt{PCmigrate-Retro.ps1}] Alternative retro DOS-style GUI (green-on-black CRT aesthetic).
