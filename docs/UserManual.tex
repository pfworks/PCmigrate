...
The Windows Migration Tool is a PowerShell-based application (with an optional GUI) that helps you move your environment from one Windows 10 or 11 machine to another. It automates the tedious parts of PC migration:
...
\begin{enumerate}
    ...
    \item Click the \textbf{{\footnotesize$\nabla$}} arrow next to Export for options: ``Export Only'' or ``Export + Create Restore Bundle''.
